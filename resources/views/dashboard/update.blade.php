<div id="update" class="tabcontent">
    ...
    <div class="row" id="forfinalinput">
        ...
        <div class="col-sm-4">
            <div class="form-label-group outline" id="forfinalcountry">
                <input type="text" id="finalcountry" class="form-control" name="finalcountry" required/>
        ...
        <div class="col-sm-4">
            <div class="form-label-group outline" id="forfinalsite">
                <input type="text" id="finalsite" class="form-control" name="finalsite" required/>
    ...
    <div class="row" id="apptype">

        <div class="col-sm-4">
            <div class="form-label-group outline" id="foroldpassfinal">
                <input type="text" id="oldpassfinal" class="form-control" name="oldpassfinal" required/>
                <span><label for="oldpassfinal">Old Passport #</label></span>
            </div>
        </div>

        <div class="col-sm-4">
            <div class="form-label-group outline" id="forpassdatefinal">
                <input type="text" id="passdatefinal" class="form-control" name="passdatefinal" required/>
                <span><label for="passdatefinal">Date Issued</label></span>
            </div>
        </div>

        <div class="col-sm-4">
            <div class="form-label-group outline" id="forissueauthfinal">
                <input type="text" id="issueauthfinal" class="form-control" name="issueauthfinal" required/>
                <span><label for="issueauthfinal">Authority</label></span>
            </div>
        </div>
